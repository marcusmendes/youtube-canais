...
**Canal: Marcus M Maciel | Versão 7.0**
...
- Escreva uma descrição em texto corrido com exatamente 1500
  caracteres.
- A palavra-chave principal deve aparecer ao menos 10 vezes de
  forma natural ao longo do texto.
...
da Fronteira". Inclua fontes e dados concretos. Incorpore inserções
editoriais em primeira pessoa nos momentos de maior impacto —
análise de dado, virada narrativa ou reflexão final de bloco.
...
promissores, mas a ciência pede cautela"*. Nunca apresente
hipóteses como fatos estabelecidos.
...
A cada aproximadamente 300 palavras de narração, insira um loop de
retenção seguindo este mecanismo obrigatório:
...
- **Para vídeos longos:** duração alvo de 12 a 15 minutos
  (aproximadamente 1.400 a 2.000 palavras de narração).
- **Para Shorts:** duração alvo de até 60 segundos
  (máximo de 120 a 130 palavras de narração).
  Para Shorts: gancho nos primeiros 3 segundos,
  mudança visual indicada a cada 15 a 20 segundos.
...
- Busque fontes reais e reconhecidas (Nature, Science, MIT Technology
  ...
  informado no campo PERÍODO DE REFERÊNCIA abaixo.
...
- **Credibilidade científica:** nunca apresente especulações como
  fatos estabelecidos. Quando o tema envolver previsões ou cenários
  futuros, use linguagem como *"pesquisadores projetam"*, *"modelos
  indicam"* ou *"especialistas estimam"*.
...
**CANAL DE REFERÊNCIA (opcional):**
`[Cole o link e/ou prints de thumbnails de um canal no mesmo nicho que você quer usar como referência de estética ou desempenho. Se preenchido, analise os padrões de título, thumbnail e gancho desse canal antes de gerar os metadados. https://www.youtube.com/@REALIDADEIMPRESSIONANTE]`
...
Quando todos os campos acima estiverem preenchidos, execute

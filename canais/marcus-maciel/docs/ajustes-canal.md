...
|---|---|---|
| **Shorts feed** | 612 | **94,6%** |
| YouTube Search | 19 | 2,9% |
| Outras páginas YT | 8 | 1,2% |
| Inscritos | 3 | 0,5% |
| Vídeos relacionados | 3 | 0,5% |
| Hashtags | 1 | 0,2% |
...
## 2. Retenção por Vídeo (dados reais via Analytics)

| Vídeo | Tipo | Views | Duração Média | % Assistido |
|---|---|---|---|---|
| V2 — A IA Viu CÂNCERES... | Short | 312 | 15s | 25,3% |
| V6 — A IA Leu Seu DNA... | Short | 134 | 16s | 25,7% |
| V3 — A IA Viu o CÂNCER... | Short | 149 | 13s | 19,4% |
| V5 — Uma Vacina DIFERENTE... | Short | 43 | 7s | 12,3% |
| V1 — IA vs Médico... | Longo | 4 | 2:37 | **30,9%** |
| V4 — E Se Existisse Uma Vacina... | Longo | 5 | 21s | 3,2% |

**Insight:** V1 (longo) tem a melhor retenção do canal (30,9%) apesar de ter só 4 views. O conteúdo longo tem qualidade — o problema é que o YouTube não está distribuindo porque falta autoridade de canal.
...
```
"inteligência artificial" "ciência e tecnologia" ia ai "IA na ciência"
"inteligência artificial e tecnologia" "inovação científica" "futuro da tecnologia"
"aprendizado de máquina na ciência" "IA e astronomia"
"descoberta de materiais com IA" "computação quântica e IA" "biotecnologia e IA"
"automação industrial" "robótica avançada" "energia renovável e IA"
"modelos de linguagem grandes" LLMs "IA generativa" "redes neurais"
"tendências tecnológicas" "desenvolvimento tecnológico"
```
...
|---|---|---|
| **Keywords aspiracionais** — termos de conteúdo que não existe no canal | "automação industrial", "energia renovável e IA", "descoberta de materiais com IA" | YouTube vê desalinhamento entre keywords e conteúdo real → perde relevância |
| **Keywords de indústria tech** — jargão de profissional, não de público geral | "LLMs", "IA generativa", "redes neurais", "aprendizado de máquina" | Público do canal não busca esses termos |
| **Faltam os temas reais do canal** | "medicina", "saúde", "câncer", "cirurgia robótica", "Neuralink", "chip cerebral" | 7/7 vídeos são sobre IA + saúde/medicina, mas nenhuma keyword reflete isso |
...
"medicina do futuro" "inteligência artificial e ciência" ia ai
...
```
A inteligência artificial está transformando a ciência e o futuro da humanidade,
e aqui você vai entender exatamente como isso funciona.

Neste canal, exploramos, em linguagem clara e visual, como a IA está acelerando
descobertas que antes levariam décadas. Acompanhe como a inteligência artificial
auxilia pesquisadores a desvendarem os mistérios do universo, criarem novos
materiais, revolucionarem a computação e abrirem portas que pareciam impossíveis
para a ciência e a tecnologia.

Do ponto de vista de quem trabalha com tecnologia há anos, eu trago para você
o que está acontecendo na fronteira do conhecimento: nos laboratórios, nas
universidades e nas maiores empresas de tecnologia do mundo, sem jargão
acadêmico e sem enrolação.

Se você quer entender como a inteligência artificial está moldando o futuro
da nossa civilização, você está no lugar certo.
```
...
| Problema | Detalhe |
|---|---|
| **Genérica** | "exploramos descobertas" — não diz quais temas |
| **Sem temas específicos** | Não menciona medicina, espaço, cérebro, robótica |
| **Sem frequência** | O espectador não sabe quando esperar conteúdo novo |
| **"linguagem clara e visual"** | Promete visual mas o canal é narração voice-over |
| **Sem diferenciação** | Qualquer canal de IA poderia ter essa descrição |
...
## 5. Categoria do Canal

Os vídeos estão na categoria **28 (Science & Technology)** — correto para o nicho. Não há necessidade de alterar.

---

## 6. Outras Configurações

| Campo | Status | Recomendação |
|---|---|---|
| País | BR | OK |
...
## 7. Análise das Playlists

### Inventário Atual

| # | Título | Vídeos | Conteúdo |
|---|---|---|---|
| P1 | 📚 Para Começar: Entenda a IA no Futuro da Humanidade | 1 | V8 Longo Neuralink (**privado**) |
| P2 | ⚡ Shorts — IA na Ciência e Tecnologia. | 8 | TODOS os Shorts (públicos + privados, todos os temas misturados) |
| P3 | 🧬 IA na Ciência e Tecnologia | 2 | V7 Longo Cirurgia + V8 Longo Neuralink (privado) |
| P4 | 🔬 IA e Câncer | 2 | V4 Longo Vacina + V1 Longo Diagnóstico |

### Problemas Identificados

**1. P1 "Para Começar" — playlist quebrada**
O único vídeo é privado. Resultado: a playlist aparece na página do canal com thumbnail `no_thumbnail.jpg` e zero conteúdo assistível. Isso passa uma impressão de canal abandonado ou mal organizado.

**2. P2 "Shorts" — todos os Shorts juntos, sem distinção temática**
Shorts sobre câncer, cirurgia robótica e Neuralink estão misturados. Um espectador que chegou por um Short sobre câncer e clica na playlist encontra conteúdo sobre chip cerebral e robôs. Perde relevância e aumenta a chance de sair.

**3. Playlists organizam por FORMATO em vez de TEMA**
Shorts em uma playlist, Longos em outra. Isso **quebra o funil Short → Longo**. O objetivo do Short é levar o espectador ao vídeo longo correspondente. Se os Shorts estão separados dos Longos, o espectador nunca faz essa transição pela playlist.

**4. Títulos sobrepostos**
- P2: "⚡ Shorts — IA na Ciência e Tecnologia**.**"
- P3: "🧬 IA na Ciência e Tecnologia"

Praticamente o mesmo nome. Confuso para o espectador e para o algoritmo.

**5. P4 "IA e Câncer" — melhor playlist, mas incompleta**
Tem os 2 longos sobre câncer, mas falta os 4 Shorts relacionados (V2, V3, V5, V6). Perde a oportunidade de manter o espectador assistindo em sequência.

**6. Typo na descrição de P2**
"curiosidades científicas e **e** ciência" — "e" duplicado.

---

### Proposta: Reestruturar por TEMA (não por formato)

A lógica é simples: playlists agrupam por **assunto**, misturando Longos e Shorts. Isso:
- Mantém o espectador no tema que o trouxe
- Aumenta tempo de sessão (watch time)
...
| Posição | Vídeo | Tipo |
|---|---|---|
| 1 | V1 — IA vs Médico: Quem Detecta CÂNCER Primeiro? | Longo |
| 2 | V2 — A IA Viu CÂNCERES que Médicos Não Viram | Short |
| 3 | V3 — A IA Viu o CÂNCER que o Dermatologista Não Viu | Short |
| 4 | V4 — E Se Existisse Uma Vacina Feita SÓ Para Você? | Longo |
...
| Posição | Vídeo | Tipo |
|---|---|---|
| 1 | V8 — Ele Perdeu a Fala. Um CHIP Devolveu Tudo | Longo |
